...
INSTALLED_APPS = [
    ...
    # Third-party apps
    'django_cleanup.apps.CleanupConfig',  # Automatically delete unused media files
        'django_extensions',  # Developer utilities (runserver_plus etc.)
...
# Note: django_extensions is included above so `runserver_plus` is available in development.
# Configure additional static files locations
STATICFILES_DIRS = [
...
# Email settings (replace with your email service details)
